    ...
    return this.Rate.aggregate([
      ...
      },
      {
        $group: {
          ...
          totalATokenSupply_avg: {
            $avg: '$totalATokenSupply',
          },
          availableLiquidity_avg: {
            $avg: '$availableLiquidity',
          },
        },
      },
      {
        $project: {
          ...
          totalATokenSupply_avg: 1,
          availableLiquidity_avg: 1,
        },
      },
      {
        $sort: {
