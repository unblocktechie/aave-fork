...
export type ReserveHistoryFeeDataV2Fragment = {
  ...
  flashLoanPremium: ReserveParamsHistoryItem['lifetimeFlashLoanPremium'];
  reserveFactorAccrued: ReserveParamsHistoryItem['lifetimeReserveFactorAccrued'];
  depositorsInterestEarned: ReserveParamsHistoryItem['lifetimeDepositorsInterestEarned'];
};

export type ReserveFeeV2ItemFragment = { __typename?: 'Reserve' } & Pick<
  Reserve,
  'symbol' | 'decimals'
> & {
...
export type ReserveFeesV2QueryVariables = Exact<{
  currentTimestamp: Scalars['Int'];
  oneDayAgoTimestamp: Scalars['Int'];
  sevenDaysAgoTimestamp: Scalars['Int'];
}>;

export type ReserveFeesV2Query = { __typename?: 'Query' } & {
  priceOracle?: Maybe<
  ...
  reserves: Array<
    { __typename?: 'Reserve' } & {
      ...
      >;
      sevenDaysAgoFees: Array<
        {
          __typename?: 'ReserveParamsHistoryItem';
        } & ReserveHistoryFeeDataV2Fragment
      >;
    } & ReserveFeeV2ItemFragment
  >;
};

export type LiquidityReserveItemV2Fragment = { __typename?: 'Reserve' } & Pick<
  Reserve,
  | 'id'
  | 'symbol'
  | 'decimals'
...
export type LiquidityReserveHistoryDataV2Fragment = {
  __typename?: 'ReserveParamsHistoryItem';
} & Pick<
...
export type LiquidityReservesQueryQueryVariables = Exact<{
  poolId: Scalars['String'];
}>;

export type LiquidityReservesQueryQuery = { __typename?: 'Query' } & {
  reserves: Array<{ __typename?: 'Reserve' } & LiquidityReserveItemV2Fragment>;
};

export type LiquidityReserveParamsHistoryItemsQueryVariables = Exact<{
  timeReference: Scalars['Int'];
  reserve: Scalars['String'];
}>;

export type LiquidityReserveParamsHistoryItemsQuery = {
  __typename?: 'Query';
} & {
  reserveParamsHistoryItems: Array<
    {
      __typename?: 'ReserveParamsHistoryItem';
    } & LiquidityReserveHistoryDataV2Fragment
  >;
};

export type PriceOracleQueryVariables = Exact<{ [key: string]: never }>;

export type PriceOracleQuery = { __typename?: 'Query' } & {
  priceOracle?: Maybe<
    { __typename?: 'PriceOracle' } & Pick<PriceOracle, 'usdPriceEth'>
  >;
};

export type HistoryItemsQueryVariables = Exact<{
  first: Scalars['Int'];
  from: Scalars['Int'];
}>;

export type HistoryItemsQuery = { __typename?: 'Query' } & {
  reserveParamsHistoryItems: Array<
...
export type ReserveDataV2Fragment = { __typename?: 'Reserve' } & Pick<
  Reserve,
  | 'id'
  | 'underlyingAsset'
  | 'name'
...
export type ReservesQuery = { __typename?: 'Query' } & {
  reserves: Array<{ __typename?: 'Reserve' } & ReserveDataV2Fragment>;
};

export type ReserveRatesHistoryDataV2Fragment = {
  __typename?: 'ReserveParamsHistoryItem';
} & Pick<
  ReserveParamsHistoryItem,
  | 'id'
...
export type MarketsDataQueryVariables = Exact<{
  timestamp?: Maybe<Scalars['Int']>;
  poolIds?: Maybe<Array<Scalars['String']> | Scalars['String']>;
}>;

export type MarketsDataQuery = { __typename?: 'Query' } & {
  reserves: Array<
    { __typename?: 'Reserve' } & {
      paramsHistory: Array<
        {
          __typename?: 'ReserveParamsHistoryItem';
        } & ReserveRatesHistoryDataV2Fragment
      >;
    } & ReserveDataV2Fragment
  >;
  priceOracle?: Maybe<
    { __typename?: 'PriceOracle' } & Pick<PriceOracle, 'usdPriceEth'>
  >;
...
export type UserReserveV2Fragment = { __typename?: 'UserReserve' } & Pick<
  UserReserve,
  | 'id'
  | 'scaledATokenBalance'
...
export type UserReservesQuery = { __typename?: 'Query' } & {
  items: Array<{ __typename?: 'UserReserve' } & UserReserveV2Fragment>;
};
...
export const ReserveHistoryFeeDataV2FragmentDoc = gql`
  fragment ReserveHistoryFeeDataV2 on ReserveParamsHistoryItem {
    flashLoanPremium: lifetimeFlashLoanPremium
    reserveFactorAccrued: lifetimeReserveFactorAccrued
    depositorsInterestEarned: lifetimeDepositorsInterestEarned
  }
`;
export const ReserveFeeV2ItemFragmentDoc = gql`
  fragment ReserveFeeV2Item on Reserve {
    symbol
    decimals
    price {
      priceInEth
...
`;
export const LiquidityReserveItemV2FragmentDoc = gql`
  fragment LiquidityReserveItemV2 on Reserve {
    id
    symbol
    decimals
    totalLiquidity
...
`;
export const LiquidityReserveHistoryDataV2FragmentDoc = gql`
  fragment LiquidityReserveHistoryDataV2 on ReserveParamsHistoryItem {
    timestamp
    totalLiquidity
    availableLiquidity
    lifetimeScaledVariableDebt
...
`;
export const ReserveDataV2FragmentDoc = gql`
  fragment ReserveDataV2 on Reserve {
    id
    underlyingAsset
    name
    symbol
...
`;
export const ReserveRatesHistoryDataV2FragmentDoc = gql`
  fragment ReserveRatesHistoryDataV2 on ReserveParamsHistoryItem {
    id
    timestamp
    totalLiquidity
    availableLiquidity
...
`;
export const UserReserveV2FragmentDoc = gql`
  fragment UserReserveV2 on UserReserve {
    id
    scaledATokenBalance
    usageAsCollateralEnabledOnUser
    stableBorrowRate
...
`;
export const ReserveFeesV2Document = gql`
  query ReserveFeesV2(
    $currentTimestamp: Int!
    $oneDayAgoTimestamp: Int!
    $sevenDaysAgoTimestamp: Int!
  ) {
    priceOracle(id: 1) {
      usdPriceEth
    }
    reserves {
      ...ReserveFeeV2Item
      currentFees: paramsHistory(
        where: { timestamp_lte: $currentTimestamp }
        orderBy: timestamp
        orderDirection: desc
        first: 1
      ) {
      ...
      oneDayAgoFees: paramsHistory(
        where: { timestamp_lte: $oneDayAgoTimestamp }
        orderBy: timestamp
        orderDirection: desc
        first: 1
      ) {
      ...
      sevenDaysAgoFees: paramsHistory(
        where: { timestamp_lte: $sevenDaysAgoTimestamp }
        orderBy: timestamp
        orderDirection: desc
        first: 1
      ) {
  ...
  ${ReserveFeeV2ItemFragmentDoc}
  ${ReserveHistoryFeeDataV2FragmentDoc}
`;
export const LiquidityReservesQueryDocument = gql`
  query LiquidityReservesQuery($poolId: String!) {
    reserves(where: { pool: $poolId }) {
      ...LiquidityReserveItemV2
    }
  }
  ${LiquidityReserveItemV2FragmentDoc}
`;
export const LiquidityReserveParamsHistoryItemsDocument = gql`
  query LiquidityReserveParamsHistoryItems(
    $timeReference: Int!
    $reserve: String!
  ) {
    reserveParamsHistoryItems(
      ...
      ...LiquidityReserveHistoryDataV2
    }
  }
  ${LiquidityReserveHistoryDataV2FragmentDoc}
`;
export const PriceOracleDocument = gql`
  query PriceOracle {
    priceOracle(id: 1) {
      usdPriceEth
    }
...
`;
export const HistoryItemsDocument = gql`
...
export const ReservesDocument = gql`
  ...
  ${ReserveDataV2FragmentDoc}
`;
export const MarketsDataDocument = gql`
  query MarketsData($timestamp: Int, $poolIds: [String!]) {
    reserves(where: { pool_in: $poolIds }) {
      ...ReserveDataV2
      paramsHistory(
  ...
  ${ReserveDataV2FragmentDoc}
  ${ReserveRatesHistoryDataV2FragmentDoc}
`;
export const UserReservesDocument = gql`
  ...
  ${UserReserveV2FragmentDoc}
`;
export const DailyVolumeV2Document = gql`
  query DailyVolumeV2($blocknumber: Int!) {
    priceOracle(id: 1) {
      usdPriceEth
    }
...
export function getSdk(
  ...
  return {
    ReserveFeesV2(
      variables: ReserveFeesV2QueryVariables,
      requestHeaders?: Headers,
    ): Promise<{
      data?: ReserveFeesV2Query | undefined;
      extensions?: any;
      headers: Headers;
      status: number;
      ...
      return withWrapper(() =>
        client.rawRequest<ReserveFeesV2Query>(
          print(ReserveFeesV2Document),
          variables,
          requestHeaders,
        ),
      );
    },
    LiquidityReservesQuery(
      variables: LiquidityReservesQueryQueryVariables,
      requestHeaders?: Headers,
    ): Promise<{
      data?: LiquidityReservesQueryQuery | undefined;
      extensions?: any;
      headers: Headers;
      status: number;
      errors?: GraphQLError[] | undefined;
      ...
      return withWrapper(() =>
        client.rawRequest<LiquidityReservesQueryQuery>(
          print(LiquidityReservesQueryDocument),
          variables,
          requestHeaders,
        ),
      );
    },
    LiquidityReserveParamsHistoryItems(
      variables: LiquidityReserveParamsHistoryItemsQueryVariables,
      requestHeaders?: Headers,
    ): Promise<{
      data?: LiquidityReserveParamsHistoryItemsQuery | undefined;
      extensions?: any;
      headers: Headers;
      status: number;
      errors?: GraphQLError[] | undefined;
      ...
      return withWrapper(() =>
        client.rawRequest<LiquidityReserveParamsHistoryItemsQuery>(
          print(LiquidityReserveParamsHistoryItemsDocument),
          variables,
          requestHeaders,
        ),
      );
    ...
    PriceOracle(
      variables?: PriceOracleQueryVariables,
      requestHeaders?: Headers,
    ): Promise<{
      data?: PriceOracleQuery | undefined;
      extensions?: any;
      headers: Headers;
      status: number;
      errors?: GraphQLError[] | undefined;
      ...
      return withWrapper(() =>
        client.rawRequest<PriceOracleQuery>(
          print(PriceOracleDocument),
          variables,
          requestHeaders,
        ),
      );
    ...
    HistoryItems(
      variables: HistoryItemsQueryVariables,
      requestHeaders?: Headers,
    ): Promise<{
      data?: HistoryItemsQuery | undefined;
      extensions?: any;
      headers: Headers;
      status: number;
      errors?: GraphQLError[] | undefined;
      ...
      return withWrapper(() =>
        client.rawRequest<HistoryItemsQuery>(
          print(HistoryItemsDocument),
          variables,
          requestHeaders,
        ),
      );
    ...
    MarketsData(
      variables?: MarketsDataQueryVariables,
      requestHeaders?: Headers,
    ): Promise<{
      data?: MarketsDataQuery | undefined;
      extensions?: any;
      headers: Headers;
      status: number;
      errors?: GraphQLError[] | undefined;
      ...
      return withWrapper(() =>
        client.rawRequest<MarketsDataQuery>(
          print(MarketsDataDocument),
          variables,
          requestHeaders,
        ),
      );
