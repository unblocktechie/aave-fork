...
const FONT = 'Inter, Poppins, Arial';
...
export const getDesignTokens = (mode: 'light' | 'dark') => {
  ...
  return {
    breakpoints: {
      ...
      values: { xs: 0, xsm: 640, sm: 760, md: 960, lg: 1110, xl: 1110, xxl: 1110 },
    },
    palette: {
      mode,
      primary: {
      ...
      text: {
        ...
        secondary: getColor('#62677B', '#94A1CA'),
        disabled: getColor('#D2D4DC', '#62677B'),
        muted: getColor('#A5A8B6', '#94A1CA'),
        highlight: getColor('#383D51', '#C9B3F9'),
      },
      background: {
        default: getColor('#F1F1F3', '#040A1E'),
        paper: getColor('#FFFFFF', '#292E41'),
        surface: getColor('#F7F7F9', '#09122E'),
        surface2: getColor('#F9F9FB', '#09122E'),
        header: getColor('#2B2D3C', 'transparent'),
        disabled: getColor('#EAEBEF', '#EBEBEF14'),
      },
      divider: getColor('#EAEBEF', '#283A7D'),
      action: {
      ...
      gradients: {
        aaveGradient:
          'linear-gradient(90deg, rgba(51, 119, 255, 0.25) 0%, rgba(51, 182, 255, 0.25) 94.08%),\n' +
          'linear-gradient(90deg, #333AFF 0%, #33B6FF 94.08%)',
        newGradient: '#3377FF',
      },
    },
    spacing: 4,
