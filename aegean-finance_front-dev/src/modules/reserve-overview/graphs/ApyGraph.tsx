...
export type TooltipData = FormattedReserveHistoryItem;
 ...
 *
 */
export const formatDate = (d: Date, timeRange: ReserveRateTimeRange) => {
  if (timeRange === '1m') {
...
type Field = 'liquidityRate' | 'stableBorrowRate' | 'variableBorrowRate' | 'availableLiquidity' | 'totalATokenSupply';
    ...
    return (
      <>
        <svg width={'100%'} height={height}>
          <LinearGradient id="area-background-gradient">
            <stop offset="18.13%" stopColor="#4A87FF" stopOpacity="0.15" />
            <stop offset="94.15%" stopColor="#27439D" stopOpacity="0" />
          </LinearGradient>
