...
import { RepayActions } from '../../components/transactions/Repay/RepayActions';
import { RepayAsset } from '../../components/transactions/Repay/RepayModalContent';
...
export const RepayInfo = ({
  ...
  const disableRepay = !poolReserve.isActive || poolReserve.isPaused;
  ...
  return (
    <>
      <PercentageInput
        ...
        balance={maxAmountToRepay.toString(10)}
