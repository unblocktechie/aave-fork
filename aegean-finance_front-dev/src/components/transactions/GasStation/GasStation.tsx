...
import { GasIcon } from '../../../assets/svgComponents/GasIcon';
...
export const GasStation: React.FC<GasStationProps> = ({
  ...
  return (
    <Stack gap={6} sx={{ width: '100%' }}>
      <Box sx={{ display: 'flex', mt, justifyContent: 'space-between' }}>
        <Box sx={{ display: 'flex', alignItems: 'center' }}>
          <GasIcon style={{ marginRight: 7 }} />
          ...
          {loadingTxns && !skipLoad ? (
            ...
            <>
              <FormattedNumber
                ...
                symbol="USD"
                color="white"
                sx={{ color: 'white', fontFamily: 'Poppins', fontSize: 13, lineHeight: '13px' }}
              />
              <GasTooltip />
            </>
          ) : (
