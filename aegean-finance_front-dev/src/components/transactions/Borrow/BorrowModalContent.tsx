      ...
      >
        ...
        >
          ...
          <FormattedNumber
            ...
            percent
            variant="secondary14"
            symbolsColor={interestRateMode === InterestRate.Variable ? 'white' : '#94A1CA'}
          />
        </StyledTxModalToggleButton>
        <StyledTxModalToggleButton
        ...
        >
          ...
          <FormattedNumber
            ...
            percent
            variant="secondary14"
            symbolsColor={interestRateMode === InterestRate.Stable ? 'white' : '#94A1CA'}
          />
        </StyledTxModalToggleButton>
      </StyledTxModalToggleGroup>
    </Row>
