    ...
    <Box {...sx}>
      ...
      >
        <Box sx={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
          <Typography
            sx={{ color: 'white', fontSize: 12, lineHeight: '12px', fontFamily: 'Poppins' }}
          >
        ...
        {asset.balance && (
          <Typography
            component="div"
            variant="secondary12"
            sx={{ color: '#94A1CA', fontSize: 14, lineHeight: '14px', fontFamily: 'Poppins' }}
          >
      ...
      >
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', height: '16px', ml: 10, mt: 1 }}>
          {loading ? (
            <Box sx={{ flex: 1 }} />
          ) : (
            <FormattedNumber
