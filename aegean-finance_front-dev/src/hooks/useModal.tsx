...
export interface ModalContextType<T extends ModalArgsType> {
  ...
  openWithdrawModalData: undefined | OpenModalData;
  setOpenWithdrawModalData: (data: OpenModalData | undefined) => void;
  openSupplyModalData: OpenModalData | undefined;
  setOpenSupplyModalData: (data: OpenModalData | undefined) => void;
  openBorrowModalData: (OpenModalData & { isReserve?: boolean }) | undefined;
  setOpenBorrowModalData: (data: (OpenModalData & { isReserve?: boolean }) | undefined) => void;
  openRepayModalData: RepayModalData | undefined;
  setOpenRepayModalData: (data: RepayModalData | undefined) => void;
  openWalletDetails: boolean;
  setOpenWalletDetails: (openWalletDetails: boolean) => void;
  openDisconnect: boolean;
  setOpenDisconnect: (openDisconnect: boolean) => void;
}
...
export const ModalContextProvider: React.FC = ({ children }) => {
  ...
  const [openWithdrawModalData, setOpenWithdrawModalData] = useState<OpenModalData | undefined>(
    undefined
  );
  const [openSupplyModalData, setOpenSupplyModalData] = useState<OpenModalData | undefined>(
    undefined
  );
  const [openBorrowModalData, setOpenBorrowModalData] = useState<
    (OpenModalData & { isReserve?: boolean }) | undefined
  >(undefined);
  const [openRepayModalData, setOpenRepayModalData] = useState<RepayModalData | undefined>(
    undefined
  );
