...
type APIResponse = {
  ...
  totalATokenSupply_avg?: number;
  availableLiquidity_avg?: number;
...
export const resolutionForTimeRange = (timeRange: ReserveRateTimeRange): RatesHistoryParams => {
        ...
        .then((data: APIResponse[]) => {
          setData(
            data.map((d) => ({
              ...
              availableLiquidity: d?.availableLiquidity_avg || 0,
              totalATokenSupply: d?.totalATokenSupply_avg || 0,
            }))
          );
          setLoading(false);
        })
