...
export default function MyApp(props: MyAppProps) {
  ...
  return (
    <CacheProvider value={emotionCache}>
      ...
      <Meta
        title={'Forward Finance'}
        description={
          'Forward Finance is an Open Source Protocol to create Non-Custodial Liquidity Markets to earn interest on supplying and borrowing assets with a variable or stable interest rate. The protocol is designed for easy integration into your products and services.'
        }
      />
      <LanguageProvider>
